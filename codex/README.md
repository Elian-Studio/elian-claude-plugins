...
Current porting scope: `ai-assisted-feature-development`, `brainstorm`, `review`, and `persona-review`. Other `elian-store` skills should be added gradually after the pattern is proven.
