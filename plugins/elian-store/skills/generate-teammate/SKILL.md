...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash(python3 *scripts/*.py*), Bash(ls *), Agent, TeamCreate, TaskCreate, TaskUpdate, TaskList, TaskGet, SendMessage, TeamDelete, AskUserQuestion
